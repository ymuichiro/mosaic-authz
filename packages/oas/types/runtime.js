...
export var BASE_PATH = 'http://localhost:3001'.replace(/\/+$/, '');
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        initOverrideFn = typeof initOverrides === 'function' ? initOverrides : function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                    ...
                    case 1:
                        ...
                        init = __assign(__assign({}, overriddenInit), { body: isFormData(overriddenInit.body) || overriddenInit.body instanceof URLSearchParams || isBlob(overriddenInit.body)
                                ? overriddenInit.body
